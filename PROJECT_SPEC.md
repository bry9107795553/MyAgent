...
### 5.5 Cloud API Fallback
Automatic fallback to Zhipu AI GLM-4 when local GPU is unavailable. Zero-downtime guarantee.
...
openai, httpx, pyyaml, watchdog, chromadb, python-multipart
```
